...
| V2.0.0  | Jan-20-2023 | Add new feature: 1. clean selected text/marker color. When the left area of the plugin color turns blue, it means selected color can be cleaned now. 2. allow customized button icon |
